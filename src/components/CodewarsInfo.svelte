...
>
	...
	<div class="w-full flex flex-col text-gray-500 fill-gray-500 text-sm">
		...
		<div class="w-full flex items-center group select-none">
			...
			<div
				class="pl-2 group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm"
				href="#"
			>
		...
		<div class="w-full flex items-center group select-none">
			...
			<div
				class="pl-2 group-hover:bg-white/10 w-full group-active:scale-95 self-stretch rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm"
				href="#"
			>
