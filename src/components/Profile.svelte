...
<div class="flex flex-row">
	<div class="menu-container text-center bg-blue-900 rounded-lg p-5 m-10">
		...
		<div class={sectionStyles}><p class={sectionStyles}>
			Socials:
			<div id="socials">
			...
			<div id="socialsMenu" class="hidden">
				<form method="POST" action="?/addSocials" use:enhance>
					<span class='pr-3'>LinkedIn: </span><input class= 'text-black m-1' id="linkedin" name="linkedinUser" placeholder="url"/>
					<span>Codewars: </span><input class= 'text-black m-1' id="codewars" name="codewarsUser" placeholder="username" />
